...
export const translations: Record<LanguageKey, Translation> = {
  ...
  en: {
    ...
    friendSelectServer: 'Select group:',
    ...
    selectServerType: 'Select voice group type',
    selectServerTypeDescription: 'Please select the type of voice group',
    ...
    noRecentServers: "haven't visited the voice group lately",
